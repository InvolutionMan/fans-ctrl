...
#ifndef FANSCTRL_SWIFT_H
#define FANSCTRL_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FansCtrl",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSWindow;
SWIFT_CLASS("_TtC8FansCtrl11AppDelegate")
